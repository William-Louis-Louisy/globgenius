...
export default function GameModeCard({
  ...
  return (
    <div className="relative flex flex-col items-start justify-between gap-4 p-6 rounded-xl shadow mt-12 bg-element card-pattern">
      ...
      <span className="font-medium text-lg underline underline-offset-2 decoration-accent">
        {title}
      </span>
